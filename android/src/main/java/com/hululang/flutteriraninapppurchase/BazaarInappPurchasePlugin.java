...
/** BazaarInappPurchasePlugin */
public class BazaarInappPurchasePlugin implements MethodCallHandler {
  ...
  public void onMethodCall(final MethodCall call, final Result result) {
     ...
     */
      ...
      if (mService == null || mBillingClient == null) {
        result.error(call.method, "IAP not prepared. Check if Cafebazaar is installed.", "");
        return;
      }
